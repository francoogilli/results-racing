...
export function RaceDayCountdown() {
  ...
  return (
    <div className="w-full bg-[#282C20] overflow-hidden relative py-20 md:py-32">
      {/* Background Gradient - Radial center gray to dark #111112 */}
      <div className="absolute inset-0 z-0" />

      <div className="container mx-auto px-4 relative z-10 flex flex-col items-center justify-center min-h-75 md:min-h-100">
        {/* Countdown Numbers */}
        <div
        ...
        <motion.div
          ...
          className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none top-[-10%] md:top-[-90%]"
        >
          <div className="w-[85%] md:w-[55%] lg:w-[45%] max-w-150 rotate-12">
            <Image
